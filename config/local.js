 ...
 * be shared with others in your company.
 *
...
module.exports = {
  ...
  // ssl: {
  //   ca: require('fs').readFileSync(__dirname + '/cer/private-csr.pem'),
  //   key: require('fs').readFileSync(__dirname + '/cer/privatekey.pem'),
  //   cert: require('fs').readFileSync(__dirname + '/cer/certificate.pem')
  // },
